...
export const metadata: Metadata = {
  title: 'Aegis-Care - Sovereign medical data',
  description: 'Patient-first consent protocol for healthcare data access and auditability.',
};
      ...
      <div className="landing-page">
        ...
        <nav className="top" id="nav">
          <div className="navshell">
            ...
            <div className="navactions">
              ...
              <a href="#connect" className="cta lime" data-magnetic>
          ...
          <div className="wrap" style={{ position: 'relative', zIndex: 2 }}>
            ...
            <div className="lede-row">
              ...
              <div className="ctas reveal d4">
                ...
                <a href="#beneficiary" className="cta">Beneficiary login</a>
              </div>
            </div>
        ...
        <section className="section tinted" id="roles">
          <div className="wrap">
            ...
            <div className="roles">
              <a href="/dashboard" style={{ textDecoration: 'none', color: 'inherit' }} className="role big reveal d1">
                <div>
                  <div className="icn">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                      <circle cx="12" cy="8" r="4"/>
              ...
              <a href="/hospital-dashboard" style={{ textDecoration: 'none', color: 'inherit' }} className="role reveal d2" data-c="lime">
                <div>
                  <div className="icn">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                      <path d="M3 21V7l9-4 9 4v14"/>
              ...
              <a href="/doctor-dashboard" style={{ textDecoration: 'none', color: 'inherit' }} className="role reveal d2" data-c="coral">
                <div>
                  <div className="icn">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
                      <path d="M6 2v6a6 6 0 0 0 12 0V2"/>
        ...
        <section className="finalcta">
          <div className="wrap">
            ...
            <div className="ctas reveal d3">
              ...
              <a href="#admin" className="cta">Institutional access</a>
            </div>
          </div>
        </section>
