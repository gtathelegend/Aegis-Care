...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      document.querySelectorAll('.blobs i').forEach((el, index) => {
        const factor = [0.08, 0.12, -0.06][index] || 0.1;
        (el as HTMLElement).style.transform = `translate3d(0, ${y * factor}px, 0)`;
      });
    };
            ...
            <div className="card reveal d3">
              <div className="head">
                <div>
                  ...
                  <div className="sub" style={{ marginTop: '4px' }}>encrypted · IPFS-pinned</div>
                </div>
                <div className="actions">
              ...
              <div className="recs">
                <div className="rec" data-c="lime">
                  <div className="top">
                    ...
                    <span className="chip-s">Lab</span>
                  </div>
                  <h4>Blood panel</h4>
                  <p>Helix Hospital · 18 Apr 26</p>
                  <div className="cid">bafy…k2qj9djd</div>
                </div>
                <div className="rec" data-c="coral">
                  <div className="top">
                    <div className="icn">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <circle cx="12" cy="12" r="9" />
                    ...
                    <span className="chip-s">Imaging</span>
                  </div>
                  <h4>Chest X-ray</h4>
                  <p>Dr. Hanwa · 14 Apr 26</p>
                  <div className="cid">bafy…8x2n4p</div>
                </div>
                <div className="rec" data-c="sky">
                  <div className="top">
                    <div className="icn">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <span className="chip-s">Prescription</span>
                  </div>
                  <h4>Rx · Azith. 500mg</h4>
                  <p>Nil Pharmacy · 12 Apr 26</p>
                  <div className="cid">bafy…p7l1qe</div>
                </div>
                <div className="rec" data-c="lime">
                  <div className="top">
                    <div className="icn">
                  ...
                  <h4>Lipid profile</h4>
                  <p>Meridian Labs · 09 Apr 26</p>
                  <div className="cid">bafy…y4m82r</div>
                </div>
                <div className="rec" data-c="coral">
                  <div className="top">
                    <div className="icn">
                    ...
                    <span className="chip-s">Visit</span>
                  </div>
                  <h4>Follow-up note</h4>
                  <p>Helix Hospital · 04 Apr 26</p>
                  <div className="cid">bafy…w9k0c3</div>
                </div>
                <div className="rec" data-c="sky">
                  <div className="top">
                    <div className="icn">
                    ...
                    <span className="chip-s">Vitals</span>
                  </div>
                  <h4>BP timeline</h4>
                  <p>Self-recorded · 29 Mar 26</p>
                  <div className="cid">bafy…r3t29s</div>
                </div>
              </div>
            </div>
          </div>
