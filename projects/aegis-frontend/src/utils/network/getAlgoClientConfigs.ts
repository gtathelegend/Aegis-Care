...
export function getAlgorandClientFromViteEnvironment(): AlgorandClient {
  const kmdConfig = import.meta.env.VITE_KMD_SERVER ? getKmdConfigFromViteEnvironment() : undefined
